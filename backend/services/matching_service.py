...
class MatchingService:
    ...
    def get_recommendations(
        ...
        # ユーザープロフィール取得
        cur.execute("""
            SELECT job_title, location_prefecture, location_city, salary_min, salary_max, employment_type, remote_work_preference
        ...
        user_preferences = {
            ...
            "location": profile_row.get("location_prefecture"),
            "location_city": profile_row.get("location_city"),
            "salary_min": profile_row.get("salary_min"),
            "salary_max": profile_row.get("salary_max"),
            "employment_type": profile_row.get("employment_type"),
            "remote_work_preference": profile_row.get("remote_work_preference"),
        } if profile_row else {}
